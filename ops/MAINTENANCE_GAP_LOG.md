...
The state-record freshness gap is suitable for a repository-only repair because it requires no new credential, connector, account selection or external side effect. All other entries remain explicit blockers or capability constraints and must not be bypassed by automation.
